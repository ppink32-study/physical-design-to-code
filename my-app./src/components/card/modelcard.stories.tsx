...
import { ModelCard, type ModelCardVariant } from "./modelcard";
 ...
 *  Matrix
 * ----------------------------------------------------------------- */
const VARIANTS: ModelCardVariant[] = ["default", "variant2"];
...
export const Matrix: Story = {
  ...
  render: () => (
    <StoryDocsMatrixPage
      title="ModelCard"
      description="모델 카드 컴포넌트 — Variant × 구성 매트릭스."
  ...
  render: () => (
    ...
    >
      ...
      <StoryDocsSection title="토큰">
        ...
        <StoryDocsParagraph><strong>썸네일</strong>: --accent-blue-accent-blue + --context-background-tint-bg-blue-tint-hover</StoryDocsParagraph>
      </StoryDocsSection>
    </StoryDocsPage>
  ),
};
